...
namespace ECSL.Systems
{
        ...
        where T3 : IComponent
    {
        ...
        protected internal override void Update(GameTime gameTime)
        {
            ...
            foreach (var entity in entities.Values)
            {
                Process(gameTime, (T1)entity.Components[typeof(T1)],
                    (T2)entity.Components[typeof(T2)], (T3)entity.Components[typeof(T3)]);
            }
            PostUpdate(gameTime);
        }

        protected abstract void Process(GameTime gameTime, T1 component1,
            T2 component2, T3 component3);
        ...
        private void Pool_OnComponentAdd(Object sender, ComponentEventArgs e)
        {
            ...
            if (e.Entity.Components.HasKey(typeof(T1)) &&
                e.Entity.Components.HasKey(typeof(T2)) &&
                e.Entity.Components.HasKey(typeof(T3)))
            {
